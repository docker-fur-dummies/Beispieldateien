...
#----------------------------------------------------------------------------
# 1. Einen Docker Container mit Bind Mount erstellen
#----------------------------------------------------------------------------
docker container run -d -p 80:80 -v C:\temp\Docker\website:/usr/share/nginx/html/ nginx
